      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between border-b border-transparent">
        ...
        <div className="flex items-center gap-4">
          ...
          <button
            ...
            className="cursor-pointer hidden md:flex bg-[#6c63ff] hover:bg-[#5b54e6] text-white px-5 py-2.5 rounded-full text-sm font-medium transition-colors items-center gap-2"
          >
            Dashboard
          </button>
