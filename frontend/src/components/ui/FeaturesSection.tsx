        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
          <div className="md:col-span-2 lg:col-span-1 lg:row-span-2 bg-white/5 border border-white/10 rounded-3xl p-8 relative overflow-hidden hover:-translate-y-1 hover:border-[#6c63ff]/40 transition-all duration-300 flex flex-col group">
            ...
            <p className="text-white/50 text-sm leading-relaxed mb-8 flex-1">
              Human-sounding voice agents conduct structured interviews with
              follow-up questions, natural turn-taking, and genuine empathy.
            </p>
          </div>
          ...
          {features.slice(1).map((feature) => {
            ...
            return (
              <div
                key={feature.title}
                className="bg-white/5 border border-white/10 rounded-2xl p-7 relative overflow-hidden hover:-translate-y-1 transition-all duration-300 group"
              >
                <div className="flex justify-between items-start mb-5 relative z-10">
                  ...
                  {feature.badge && (
                    <span
                      className="px-2.5 py-1 rounded-full border text-[0.65rem] font-bold tracking-widest uppercase"
                      style={{
