...
export default function LoginModel() {
  return (
    ...
    <div className="absolute top-[calc(100%+12px)] md:right-0 md:left-auto left-1/2 md:translate-x-0 -translate-x-1/2 z-50 w-[320px] max-w-[90vw] bg-white border border-gray-200 p-8 shadow-2xl rounded-2xl">
      ...
      {/* Auth Button */}
      <button className="flex items-center justify-center gap-3 w-full py-4 px-4 bg-white border border-gray-200 rounded-xl hover:bg-gray-50 hover:border-gray-300 transition-all duration-300 font-medium group relative overflow-hidden shadow-sm mt-4">
