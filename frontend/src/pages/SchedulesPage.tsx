...
// // Mocking MongoDB ObjectIds for the jobs so the backend route validates them
// const JOBS = [
//   { id: '65f1a2b3c4d5e6f7a8b9c0d1', title: 'Full Stack React Developer' },
//   { id: '65f1a2b3c4d5e6f7a8b9c0d2', title: 'Senior Backend Engineer' },
//   { id: '65f1a2b3c4d5e6f7a8b9c0d3', title: 'Product Designer' },
// ];
...
//       try {
//         // Fetch using Axios
//         const response = await axios.get(`/api/interviews/pending/${selectedJobId}`);
