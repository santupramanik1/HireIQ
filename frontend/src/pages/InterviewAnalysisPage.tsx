...
// COMPONENT
// ==========================================
export default function InterviewAnalysisPage({ onBack }: { onBack?: () => void }) {
  return (
        ...
        <div className="flex flex-col gap-4 mb-8">
          ...
          <div>
            ...
            <p className="text-slate-500 mt-1 flex items-center gap-2 text-sm sm:text-base">
              ...
              {ANALYSIS_DATA.role} <span className="mx-1">•</span> {ANALYSIS_DATA.date}
            </p>
          </div>
        </div>
            ...
            <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-6">
              ...
              <div className="flex flex-col items-center justify-center mb-8">
                <div className="text-5xl font-black text-slate-900 tracking-tighter">
                  ...
                  <span className="text-2xl text-slate-400 font-medium tracking-normal">/{ANALYSIS_DATA.scores.max}</span>
                </div>
              ...
              <div className="space-y-6">
                <div>
                  <div className="flex justify-between text-sm font-bold mb-2">
                    ...
                    <span className="text-slate-900">{ANALYSIS_DATA.scores.communication}/{ANALYSIS_DATA.scores.max}</span>
                  </div>
                ...
                <div>
                  <div className="flex justify-between text-sm font-bold mb-2">
                    ...
                    <span className="text-slate-900">{ANALYSIS_DATA.scores.technical}/{ANALYSIS_DATA.scores.max}</span>
                  </div>
                  <div className="w-full bg-slate-100 rounded-full h-2.5 overflow-hidden">
            ...
            <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-6 sm:p-8">
              ...
              <div>
                ...
                <div className="flex items-start gap-3 bg-amber-50/50 border border-amber-100 p-4 rounded-xl text-slate-700 italic text-sm font-medium">
                  <span className="material-symbols-outlined text-amber-400 shrink-0 text-[20px]" style={{ fontVariationSettings: "'FILL' 1" }}>
                    star
                  </span>
